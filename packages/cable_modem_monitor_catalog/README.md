...
**2 devices, 2 configurations** (2 ⏳ awaiting)

**Auth strategies:** none (2)
...
|--------------|-------|--------|-----------|---------|------|------|-------|--------|
| CommScope | [BGW620-700 (02002300460053)](https://github.com/solentlabs/cable_modem_monitor/blob/main/packages/cable_modem_monitor_catalog/solentlabs/cable_modem_monitor_catalog/modems/commscope/bgw620_700/modem.yaml) |  | ![HTML](https://img.shields.io/badge/-HTML-E34C26?style=flat-square "Standard web scraping") |  | ![none](https://img.shields.io/badge/-none-808080?style=flat-square "No Authentication") | [![ATT](https://img.shields.io/badge/-ATT-0091d5?style=flat-square "AT&T")](#att) | BGW620-700 | ⏳ Awaiting |
...
Generated by `scripts/generate_catalog_index.py` from 2 modem configs ([source](https://github.com/solentlabs/cable_modem_monitor/blob/main/packages/cable_modem_monitor_catalog/scripts/generate_catalog_index.py)).
