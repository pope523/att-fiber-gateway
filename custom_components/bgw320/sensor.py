"""Sensor platform for AT&T BGW320 Gateway.
...
class ModemStatusSensor(ModemSensorBase):
    ...
    def __init__(
        ...
        self._attr_unique_id = f"{entry.entry_id}_bgw320_status"
...
class ModemInfoSensor(ModemSensorBase):
    ...
    def __init__(
        ...
        self._attr_unique_id = f"{entry.entry_id}_bgw320_info"
...
class ModemErrorTotalSensor(_SystemInfoSensor):
    ...
    def __init__(
        ...
        *,
        ...
        self._attr_unique_id = f"{entry.entry_id}_bgw320_total_{error_type}"
...
class ModemErrorRateSensor(_SystemInfoSensor):
    ...
    def __init__(
        ...
        *,
        ...
        self._attr_unique_id = f"{entry.entry_id}_bgw320_rate_{error_type}"
        self._attr_icon = "mdi:alert-circle-check" if error_type == "corrected" else "mdi:alert-circle"
...
class ModemSoftwareVersionSensor(_SystemInfoSensor):
    ...
    def __init__(
        ...
        self._attr_unique_id = f"{entry.entry_id}_bgw320_software_version"
        self._attr_icon = "mdi:information-outline"
...
class ModemSystemUptimeSensor(_SystemInfoSensor):
    ...
    def __init__(
        ...
        self._attr_unique_id = f"{entry.entry_id}_bgw320_system_uptime"
...
class ModemLastBootTimeSensor(_SystemInfoSensor):
    ...
    def __init__(
        ...
        self._attr_unique_id = f"{entry.entry_id}_bgw320_last_boot_time"
...
class SystemInfoFieldSensor(_SystemInfoSensor):
    ...
    def __init__(
        ...
        *,
        ...
        self._attr_unique_id = f"{entry.entry_id}_bgw320_{field}"
        self._attr_icon = "mdi:information-outline"
    ...
    def __init__(
        ...
        *,
        ...
        if identity_mode == ChannelIdentity.NUMBER:
            ...
            self._attr_unique_id = f"{entry.entry_id}_bgw320_{dir_code}_ch_{slot_key}_{field}"
        else:
            ...
            self._attr_unique_id = f"{entry.entry_id}_bgw320_{dir_code}_{ch_type}_ch_{ch_id}_{field}"
...
class LanStatsSensor(ModemSensorBase):
    ...
    def __init__(
        ...
        *,
        ...
        self._attr_unique_id = f"{entry.entry_id}_bgw320_lan_{interface}_{field}"
        self._attr_state_class = SensorStateClass.TOTAL_INCREASING
        if device_class:
            self._attr_device_class = device_class
        if unit:
...
class PingLatencySensor(HealthSensorBase):
    ...
    def __init__(
        ...
        self._attr_unique_id = f"{entry.entry_id}_bgw320_ping_latency"
...
class TcpLatencySensor(HealthSensorBase):
    ...
    def __init__(
        ...
        self._attr_unique_id = f"{entry.entry_id}_bgw320_tcp_latency"
        self._attr_native_unit_of_measurement = "ms"
...
class HttpLatencySensor(HealthSensorBase):
    ...
    def __init__(
        ...
        self._attr_unique_id = f"{entry.entry_id}_bgw320_http_latency"
        self._attr_native_unit_of_measurement = "ms"
...
async def async_setup_entry(
    ...
    """Set up AT&T BGW320 Gateway sensor entities."""
